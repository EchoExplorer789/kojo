...
export default function Navbar(props) {
  ...
  return (
    // sidebar
    <div className='MainWebstieSideBar sidebar text-center shadow h-screen overflow-y-auto hidden lg:block' id='sidebar'>
      {/* <div className="flex justify-end"><MdClose  onClick={toggle} style={{ fontSize: '25px', color: 'white'}}/></div> */}
      <div className="p-4 m-5 flex items-center MainNavBarLoginButton" onClick={()=> setShowMyModal(true)}>
        ...
        <div className="Main">
          ...
          <span className="text-[14px] text-gray-200 ">Login / Register</span>
        </div>
      </div>
      {/* <hr className="my-2 text-gray-100 " id='hr1'></hr> */}
      <div className='MainWebsiteNavBar' onClick={Openbar}>
