...
export default function Coin(props) {
  ...
  useEffect(()=>{
    const fetchCoinData = async () => {
      try {
        const response = await axios.post('https://cors-anywhere.herokuapp.com/https://kojocalls.onrender.com/api/metadata', {
  ...
  return (
    <div>
        <table className=" lg:w-full pr-10" id='table' style={{background: "#1a1b1e"}}>
      <thead>
